package site.zawag.work.dialogs;
...
public class HotgameSettingsDialog extends DialogFragment implements Constants {
    ...
    public interface AlertPositiveListener {
        ...
        void onCloseHotgameSettingsDialog(int searchSexOrientation, int liked, int matches);
    }
    ...
    OnClickListener positiveListener = new OnClickListener() {
        ...
        public void onClick(DialogInterface dialog, int which) {
            ...
            alertPositiveListener.onCloseHotgameSettingsDialog(searchSexOrientation, hotgameLiked, hotgameMatches);
        }
    };
            ...
            public void onShow(DialogInterface dialog) {
                ...
                b.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        d.dismiss();
                        alertPositiveListener.onCloseHotgameSettingsDialog(sexOrientationSpinner.getSelectedItemPosition(), getLiked(), getMatches());
                    }
                });
