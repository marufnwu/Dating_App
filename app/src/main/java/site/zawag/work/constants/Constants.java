package site.zawag.work.constants;
...
public interface Constants {
    ...
    //String WEB_SITE = "http://zawag.site//";  //web com url address
    String WEB_SITE = "http://zawag.website//";  //web com url address
    ...
    String CLIENT_ID = "12567";  // Correct example: 12567 | Incorrect example: 0987

    //String API_DOMAIN = "http://zawag.site/";  //url address to which the application sends requests
    String API_DOMAIN = "http://zawag.website/";  //url address to which the application sends requests
