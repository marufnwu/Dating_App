...
public class UpgradesFragment extends Fragment implements Constants {
    ...
    public void update() {
        ...
        mProModeButton.setText(getString(R.string.action_enable) + " (" + PRO_MODE_COST + ")");
        ...
        if (App.getInstance().getPro() == 0) {
            ...
            mLabelProModeTitle.setText(getActivity().getString(R.string.label_upgrades_pro_mode) + " - " + getActivity().getString(R.string.label_free_messages_count) + "(" + App.getInstance().getFreeMessagesCount() +")");
