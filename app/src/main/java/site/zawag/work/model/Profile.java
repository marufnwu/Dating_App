    ...
    public Profile(JSONObject jsonData) {
        ...
        try {
            ...
            if (!jsonData.getBoolean("error")) {
                ...
                if (jsonData.has("country_name")) {

                    this.setCountry_name(jsonData.getString("country_name"));
                }

                if (jsonData.has("religion")) {

                    this.setReligion(jsonData.getInt("religion"));
                }
            }
