...
public class Helper extends Application {
    ...
    public static String getReligionTitle(Context ctx, int religion) {
        switch (religion){
            case 0:
                return ctx.getString(R.string.label_islam);
            case 1:
                return ctx.getString(R.string.label_christian);
            case 2:
                return ctx.getString(R.string.label_budhdist);
            case 3:
                return ctx.getString(R.string.label_hindu);
            case 4:
                return ctx.getString(R.string.label_religion_other);
            default:
                return ctx.getString(R.string.action_choose_religion);
            }
    }
