...
import site.zawag.work.Lang.LocaleManager;
...
public class AppActivity extends ActivityBase {
    ...
    protected void  onStart() {
        ...
        Log.d("Language", lang);
        if (!lang.equals(LocaleManager.ARABIC)){
            LocaleManager.setNewLocale(getApplicationContext(), LocaleManager.ENGLISH);
        }else {
            LocaleManager.setNewLocale(getApplicationContext(), LocaleManager.ARABIC);
            ...
            CustomRequest jsonReq = new CustomRequest(Request.Method.POST, METHOD_ACCOUNT_AUTHORIZE, null,
                    new Response.Listener<JSONObject>() {
                        ...
                        public void onResponse(JSONObject response) {
                            Log.e("InitialResponse", "Malformed JSON: \"" + response.toString() + "\"");
